...
On average, we collected about `r round(cell_summary$mean_cells, -3)` cells per sample, with the largest sample having `r round(cell_summary$max_cells, -3)` cells and the smallest sample having `r round(cell_summary$min_cells, -3)` cells.
...
And we have `r num_samples` unique samples.
